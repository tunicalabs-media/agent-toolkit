...
Agent skill packs live in the skills folder. Each skill has a definition document (often SKILL.md or a standalone skill file) that describes scope and usage rules.
...
| context-engineering         | Agent context setup and session hygiene                                                                        | Start sessions, fix hallucinations, and switch tasks cleanly.                  | [skills/context-engineering/SKILL.md](skills/context-engineering/SKILL.md)                 |
...
| frontend-developer          | React/Next.js feature delivery and UI architecture                                                             | Build components, manage client state, and optimize UX.                        | [skills/frontend-developer.md](skills/frontend-developer.md)                               |
...
| frontend-security-coder     | Secure frontend coding and XSS prevention                                                                      | Implement CSP, sanitize output, and harden DOM interactions.                   | [skills/frontend-security-coder.md](skills/frontend-security-coder.md)                     |
...
| mobile-security-coder       | Mobile security coding and WebView hardening                                                                   | Secure storage, WebView configs, and mobile auth flows.                        | [skills/mobile-security-coder.md](skills/mobile-security-coder.md)                         |
...
| nextjs-app-router-patterns  | App Router patterns, RSC, and streaming                                                                        | Build or migrate App Router features and data flows.                           | [skills/nextjs-app-router-patterns.md](skills/nextjs-app-router-patterns.md)               |
| performance-engineer        | Observability and performance optimization                                                                     | Profile bottlenecks, design caching, and run load tests.                       | [skills/performance-engineer.md](skills/performance-engineer.md)                           |
| security-auditor            | Security audits, DevSecOps, and compliance                                                                     | Threat modeling, audit prep, and pipeline security.                            | [skills/security-auditor.md](skills/security-auditor.md)                                   |
| tailwind-design-system      | Tailwind CSS v4 design system patterns                                                                         | Build tokens, variants, and standardized UI patterns.                          | [skills/tailwind-design-system/SKILL.md](skills/tailwind-design-system/SKILL.md)           |
...
| vercel-composition-patterns | React composition patterns that scale                                                                          | Replace boolean props and build compound components.                           | [skills/vercel-composition-patterns/SKILL.md](skills/vercel-composition-patterns/SKILL.md) |
...
| webapp-testing              | Playwright-based local web app testing                                                                         | Validate UI flows, capture screenshots, and debug browser behavior.            | [skills/webapp-testing/SKILL.md](skills/webapp-testing/SKILL.md)                           |
