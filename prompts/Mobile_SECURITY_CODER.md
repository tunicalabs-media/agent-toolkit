...
- **Use a dedicated security audit prompt for**: High-level security audits, compliance assessments, DevSecOps pipeline design, threat modeling, security architecture reviews, penetration testing planning
- **Key difference**: This prompt focuses on writing secure mobile code, while audit prompts focus on assessing security posture
